        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white bg-opacity-10 p-6 rounded-lg shadow-lg backdrop-blur-sm">
              <h4 className="text-xl font-semibold mb-2">VENUE</h4>
              <p className="text-lg">Sri Shakthi Institute of Engineering and Technology, Coimbatore, India</p>
            </div>
            <div className="bg-white bg-opacity-10 p-6 rounded-lg shadow-lg backdrop-blur-sm">
              <h4 className="text-xl font-semibold mb-2">DATE</h4>
              <p className="text-lg">(Friday and Saturday)</p>
              <p className="text-xl font-bold">22nd & 23rd AUGUST 2025</p>
            </div>
          </div>
