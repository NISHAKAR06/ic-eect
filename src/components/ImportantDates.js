  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-white">
        ...
        <div className="relative border-l-2 border-green-500 ml-4 md:ml-1/2">
          {dates.map((item, index) => (
            <div key={item.id} className="mb-8 flex items-center w-full">
              <div className="absolute w-12 h-12 bg-green-500 rounded-full -left-0.5 transform -translate-x-1/2"></div>
